...
1. innerRhythm (string): 감정 패턴·내면의 그림자·자기 객관화를 통합한 내면 분석 에세이.
   문단1(2문장): 어떤 구체적인 상황에서 감정이 크게 움직이는지 직접적으로 묘사. 포장하지 말고, 이 사람 사주 구조에서 왜 그런지 근거를 한 문장 안에 녹여줘.
   문단2(2문장): 약점을 완화하거나 희망적으로 포장하지 말고 구조적 사실로 서술. 회복 방식도 현실적으로. "사실 이 사람은 ~한 구조예요" 식으로 직접 말해줘.
   결론(1문장): 핵심 통찰 — 위로보다 정곡을 찌르는 한 마디.
   전체 300자 이내. 이모지·마크다운 금지.
