...
사주의 특정 기둥(연주, 월주, 일주, 시주)을 직접 지목해서 '시주의 무엇과 호응' 같은 식으로 쓰지 마. 오행이나 일간 기질 차원에서만 연결해서 완결된 문장으로 써.
...
1. innerRhythm (string): 감정 패턴·내면의 그림자·자기 객관화를 통합한 내면 분석 에세이.
   문단1(2문장): 어떤 구체적인 상황(예: "인정받지 못할 때", "예상치 못한 변화가 생길 때")에서 감정이 크게 움직이는지 묘사. "감정이 폭발해" 같은 부정적 표현 금지 — "감동을 받아", "마음이 크게 흔들려" 같은 중립·긍정 표현 사용.
