...
const ZODIAC_DESC={
  "양자리":{sun:"불꽃 같은 추진력을 타고났어. 하고 싶은 게 생기면 앞뒤 안 재고 돌진하는 순수한 에너지야. 시작하는 힘은 열두 별자리 중 최고라, 남들이 재고 망설이는 사이에 이미 저질러버려. 경쟁이 붙으면 눈빛부터 달라지고, 지는 걸 못 견뎌서 어떻게든 앞서 나가. 대신 마무리에서 힘이 빠지는 게 약점이야.",moon:"감정이 즉각적이고 솔직해. 화도 빨리 나고 푸는 것도 빨라서, 속에 담아두질 못하는 대신 뒤끝은 없어. 기분이 표정과 행동에 그대로 드러나서 숨기질 못해. 답답하게 억눌리는 상황이나 관계에선 금방 숨이 막혀. 자유롭게 움직이고 즉흥적으로 부딪힐 때 마음이 살아나는 구조야.",asc:"첫인상이 강렬하고 에너지가 넘쳐 보여. 어딜 가나 존재감이 확 드러나고, 걸음걸이나 말투에서 자신감이 뿜어져 나와. 처음 보는 사람도 활기찬 사람이라는 인상을 받아. 눈치 보지 않고 먼저 다가가는 시원시원함이 매력이라, 사람들이 쉽게 마음을 열어."},
  "황소자리":{sun:"뚝심과 끈기의 별이야. 한번 정하면 우직하게 밀고 나가고, 쉽게 흔들리지 않는 단단함이 있어. 변화를 싫어하는 대신 하나를 오래 쌓아 올리는 힘은 누구도 못 따라와. 눈에 보이고 손에 잡히는 실속을 중요하게 여겨서, 헛된 걸 좇지 않고 현실적으로 움직여. 감각이 예민해서 좋은 것, 편안한 것을 알아보는 안목도 뛰어나.",moon:"감정이 느긋하고 안정적이야. 웬만해선 흔들리지 않는 대신, 한번 삐지거나 서운하면 오래가는 편이야. 갑작스러운 변화나 불안정한 상황에선 유독 스트레스를 받아. 편안하고 익숙한 환경, 안정된 관계 속에서 마음이 채워지는 구조야.",asc:"차분하고 믿음직한 인상을 줘. 서두르지 않는 여유가 상대를 편하게 만들고, 옆에 있으면 이상하게 안정감이 느껴지는 타입이야. 말이나 행동이 진중해서 신뢰가 빨리 쌓여. 화려하게 튀진 않아도 은근히 감각 있는 분위기가 배어나와."},
  "쌍둥이자리":{sun:"머리 회전이 빠르고 호기심이 끝이 없어. 말재주와 재치가 무기라, 어떤 자리에서도 대화를 살리고 분위기를 가볍게 만들어. 새로운 정보와 자극을 먹고 사는 사람이라 배우고 연결하고 퍼뜨리는 일에 강해. 여러 가지를 동시에 다루는 멀티 능력도 뛰어나.",moon:"감정이 머리로 먼저 가. 느끼기 전에 분석부터 하는 편이라, 스스로도 자기 감정을 헷갈려할 때가 있어. 같은 자리에 오래 머무는 걸 못 견뎌서, 변화와 새로운 자극이 있어야 마음이 살아나. 답답하고 반복되는 일상에선 금방 지루해져.",asc:"밝고 사교적인 인상이야. 말을 잘 걸고 분위기를 가볍게 만드는 재주가 있어서, 처음 보는 사람과도 금방 편해져. 표정이 살아있고 반응이 빨라서 함께 있으면 지루할 틈이 없어. 어려 보이고 트렌디한 분위기를 풍기는 것도 이 별의 특징이야."},
  "게자리":{sun:"정이 많고 품이 넓은 별이야. 내 사람이라고 정한 사람은 끝까지 챙기고 지키는 따뜻함이 있어. 공감 능력이 깊어서 남의 아픔을 그냥 지나치질 못해. 가족이나 가까운 사람을 향한 마음이 유독 각별하고, 그들을 위해서라면 강해지는 사람이야. 감수성이 풍부한 만큼 상처도 깊게 받는 게 약점이야.",moon:"감정의 깊이가 남달라. 공감 능력이 뛰어나서 가까운 사람의 기분을 그대로 흡수하고, 분위기만으로도 상대의 마음을 읽어. 안전한 울타리 안에서 마음이 놓이는 구조라, 편안한 집과 믿을 수 있는 사람이 곁에 있을 때 가장 안정돼.",asc:"부드럽고 다정한 인상이야. 처음엔 낯을 가리고 조심스러워 보여도, 한번 마음을 열면 따뜻하게 품어주는 사람이라는 게 느껴져. 상대를 편하게 배려하는 세심함이 자연스럽게 배어나와. 눈빛이나 표정에 정이 담겨 있어서 사람들이 무의식적으로 기대게 돼."},
  "사자자리":{sun:"타고난 주인공이야. 빛나는 자리가 어울리고, 사람을 끌어당기고 이끄는 카리스마가 있어. 당당하고 자존심이 강해서 위축되기보다 정면으로 부딪히는 걸 택해. 한번 마음먹으면 화끈하게 밀어붙이고, 사람에게도 아낌없이 베푸는 큰 그릇이야.",moon:"감정 표현이 화려하고 당당해. 사랑도 크게 주고 크게 받길 원하는 뜨거운 마음이야. 인정받고 주목받을 때 마음이 가장 충만해지고, 반대로 무시당하거나 존재감이 흐려질 때 깊이 위축돼. 자존심이 감정의 핵심이라, 자존심이 상하면 겉으론 당당한 척해도 속으론 오래 앓아.",asc:"화려하고 당당한 인상이야. 가만히 있어도 눈길이 가는 존재감을 뿜어내고, 자세나 표정에서 자신감이 자연스럽게 드러나. 사람들 앞에 서는 게 어색하지 않아서, 어느 자리에 가든 중심으로 끌려 들어가는 타입이야. 밝고 시원시원한 매력이 사람을 끌어당겨."},
  "처녀자리":{sun:"섬세하고 완벽을 추구하는 별이야. 디테일을 놓치지 않고, 뭐든 제대로 해내려는 성실함이 몸에 배어 있어. 문제를 분석하고 정리하고 개선하는 능력이 탁월해서, 어디서든 없으면 안 되는 사람이 돼. 남을 돕고 실질적으로 챙기는 데서 보람을 느끼는 따뜻함도 있어.",moon:"감정을 분석하고 정리하려 해. 느끼는 대로 두기보다 왜 이런 기분인지 따지는 편이라, 걱정이 많고 예민해. 그만큼 주변을 세심하게 챙기고 미리 대비하는 힘이 강해. 정돈되고 예측 가능한 환경에서 마음이 안정되는 구조라, 어수선하거나 통제 안 되는 상황에선 불안이 커져.",asc:"단정하고 깔끔한 인상이야. 빈틈없어 보이면서도 은근히 친근한 매력이 있어서 신뢰가 빨리 쌓여. 말과 행동에 군더더기가 없고, 상대를 세심하게 배려하는 게 자연스럽게 드러나. 차분하고 정돈된 분위기가 믿을 만한 사람이라는 인상을 줘."},
  "천칭자리":{sun:"균형과 조화의 별이야. 사람 사이를 매끄럽게 조율하고, 어느 한쪽으로 치우치지 않으려는 공정함이 있어. 미적 감각이 뛰어나서 아름다운 것, 세련된 것을 알아보고 만들어내는 재능이 있어. 혼자보다 함께일 때 빛나는 관계 지향형이라, 파트너십이 삶의 중요한 축이야.",moon:"관계 속에서 마음이 안정돼. 갈등을 싫어하고 평화를 지키려는 성향이 강해서, 부딪힐 상황을 미리 피하거나 맞춰주는 편이야. 혼자 있는 것보다 마음 맞는 사람과 함께일 때 편안해지는 구조야. 공정하지 못한 상황이나 험한 분위기에 유독 예민하게 반응해.",asc:"세련되고 우아한 인상이야. 부드러운 매너와 균형 잡힌 분위기로 상대를 편하게 만드는 재주가 있어. 표정이나 말투에 은은한 품위가 배어 있어서 첫인상에서 호감을 쉽게 얻어. 사람을 대하는 태도가 공평하고 친절해서 적을 잘 안 만들어."},
  "전갈자리":{sun:"강렬하고 깊이 있는 별이야. 한번 빠지면 끝을 보는 몰입력과, 겉으론 차분해도 속엔 뜨거운 게 끓는 이중성이 있어. 통찰력이 날카로워서 표면 아래 숨은 진짜를 꿰뚫어 봐. 어설픈 관계나 얕은 관심엔 흥미가 없고, 전부를 걸 만한 깊은 연결을 원해.",moon:"감정이 깊고 강렬해. 쉽게 드러내지 않지만 한번 마음을 주면 전부를 거는 사람이야. 신뢰가 감정의 핵심이라, 믿음이 쌓이면 끝까지 지키지만 신뢰가 무너지면 돌아서는 것도 확실해. 속을 잘 안 보여줘서 가까운 사람도 그 깊이를 다 알기 어려워. 감정을 안으로 삭이다 혼자 무거워지는 경우가 많아.",asc:"신비롭고 묘한 인상이야. 쉽게 속을 안 보여줘서 더 끌리는 타입이라, 첫인상부터 궁금증을 자아내. 눈빛에 힘이 있고, 말수가 적어도 존재감이 묵직해. 가볍게 다가오는 사람에겐 벽을 두지만, 진심이 느껴지는 사람에겐 서서히 깊이를 내줘."},
  "사수자리":{sun:"자유와 모험의 별이야. 넓은 세상을 향한 갈망이 커서, 익숙한 자리에 머무는 걸 못 견뎌. 낙천적이고 솔직해서 마음에 담아두는 게 없고, 어디서든 긍정적인 기운을 퍼뜨려. 새로운 경험과 배움, 여행과 도전에서 살아나는 사람이야. 큰 그림을 그리고 의미를 좇는 철학적인 면도 있어.",moon:"감정이 낙천적이고 시원시원해. 우울해도 금방 털고 일어나는 회복력이 있어서, 무거운 감정을 오래 붙들지 않아. 새로운 경험과 자유가 보장될 때 마음이 살아나는 구조라, 갇히고 통제받는 상황에선 숨이 막혀. 솔직해서 감정을 숨기지 못하는데, 가끔 그 직설이 상대에게 상처가 될 수도 있어.",asc:"밝고 활기찬 인상이야. 스스럼없이 다가가는 친화력으로 어딜 가나 잘 어울리고, 함께 있으면 기분이 가벼워지는 사람이야. 솔직하고 유쾌한 말투가 벽을 금방 허물어. 자유로운 분위기와 열린 태도가 사람들을 편하게 만들어."},
  "염소자리":{sun:"책임감과 인내의 별이야. 목표를 향해 묵묵히 오르는 등산가 기질이라, 느려도 결국 정상에 서는 사람이야. 현실적이고 계획적이어서, 헛된 꿈보다 실현 가능한 목표를 하나씩 이뤄가. 참을성과 자기 관리가 뛰어나서 긴 승부에 강해. 사회적 성취와 인정에서 삶의 의미를 찾는 편이야.",moon:"감정을 잘 드러내지 않고 안으로 삼켜. 진중하고 무게감 있어 보이지만, 속으로는 외로움과 부담을 많이 지고 사는 편이야. 성취하고 인정받을 때 안정을 느끼는 구조라, 스스로에게 요구하는 기준이 늘 높아. 약한 모습을 보이는 걸 자존심이 허락하지 않아서, 힘들어도 혼자 버티다 곪을 때가 있어.",asc:"진중하고 어른스러운 인상이야. 쉽게 흔들리지 않는 단단함이 신뢰를 주고, 나이보다 성숙해 보이는 무게감이 있어. 말과 행동이 신중해서 함부로 대하기 어려운 분위기를 자연스럽게 풍겨. 책임감 있어 보여서 일과 관계 모두에서 믿음을 빨리 얻어."},
  "물병자리":{sun:"독창적이고 자유로운 별이야. 남들과 다른 시선으로 세상을 보고, 틀에 갇히는 걸 거부하는 개성이 뚜렷해. 관습에 얽매이지 않고 왜 꼭 그래야 하냐고 묻는 혁신가 기질이 있어. 사람을 편견 없이 대하고, 넓은 인류애와 공동체 감각도 강해. 지적 호기심이 많아 늘 새로운 아이디어를 좇아.",moon:"감정을 객관적으로 봐. 한 발 떨어져 관찰하는 편이라 차가워 보이기도 하지만, 실은 감정에 휩쓸리지 않으려는 자기 방어야. 자유와 독립이 보장될 때 마음이 편해지는 구조라, 속박하거나 지나치게 밀착하는 관계엔 숨이 막혀. 남들과 다른 자기만의 방식을 존중받고 싶은 마음이 커.",asc:"독특하고 개성 있는 인상이야. 어딘가 남다른 분위기로 사람들의 호기심을 끌고, 흔한 틀에 안 갇히는 자유로움이 매력이야. 편견 없이 사람을 대해서 누구와도 스스럼없이 어울려. 쿨하고 시원한 태도가 세련돼 보여."},
  "물고기자리":{sun:"감수성과 상상력의 별이야. 공감 능력이 깊고 예술적 기질이 강해서, 남이 못 느끼는 결까지 섬세하게 잡아내. 경계가 흐릿해서 타인의 감정에 쉽게 스며들고, 그만큼 따뜻하게 품어주는 힘이 있어. 현실 너머의 아름다움과 의미를 좇는 몽상가이자, 상처받은 사람을 그냥 지나치지 못하는 치유자야.",moon:"감정이 바다처럼 깊고 넓어. 타인의 아픔을 내 것처럼 느끼는 공감력이 강해서, 주변 분위기를 그대로 흡수해버려. 꿈과 예술, 음악과 물처럼 부드러운 것 속에서 마음이 치유되는 구조야. 감정의 파도가 크게 오르내려서, 이유 없이 벅차거나 가라앉는 날이 많아.",asc:"부드럽고 몽환적인 인상이야. 어딘가 신비롭고 포근한 분위기로 사람을 끌어당기고, 함께 있으면 마음이 편안해지는 사람이야. 눈빛이 따뜻하고 상대를 잘 받아줘서, 사람들이 무장 해제되고 속마음을 털어놓게 돼. 예술적이고 감성적인 기운이 자연스럽게 배어나와."}
};
