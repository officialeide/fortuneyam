...
const ZODIAC_DESC={
  "양자리":{sun:"불꽃 같은 추진력을 타고났어. 하고 싶은 게 생기면 앞뒤 안 재고 돌진하는 순수한 에너지야. 시작하는 힘은 열두 별자리 중 최고라, 남들이 재고 망설이는 사이에 이미 저질러버려.",moon:"감정이 즉각적이고 솔직해. 화도 빨리 나고 푸는 것도 빨라서, 속에 담아두질 못하는 대신 뒤끝은 없어. 기분이 표정과 행동에 그대로 드러나서 숨기질 못해.",asc:"첫인상이 강렬하고 에너지가 넘쳐 보여. 어딜 가나 존재감이 확 드러나고, 걸음걸이나 말투에서 자신감이 뿜어져 나와. 처음 보는 사람도 활기찬 사람이라는 인상을 받아."},
  "황소자리":{sun:"뚝심과 끈기의 별이야. 한번 정하면 우직하게 밀고 나가고, 쉽게 흔들리지 않는 단단함이 있어. 변화를 싫어하는 대신 하나를 오래 쌓아 올리는 힘은 누구도 못 따라와.",moon:"감정이 느긋하고 안정적이야. 웬만해선 흔들리지 않는 대신, 한번 삐지거나 서운하면 오래가는 편이야. 갑작스러운 변화나 불안정한 상황에선 유독 스트레스를 받아.",asc:"차분하고 믿음직한 인상을 줘. 서두르지 않는 여유가 상대를 편하게 만들고, 옆에 있으면 이상하게 안정감이 느껴지는 타입이야. 말이나 행동이 진중해서 신뢰가 빨리 쌓여."},
  "쌍둥이자리":{sun:"머리 회전이 빠르고 호기심이 끝이 없어. 말재주와 재치가 무기라, 어떤 자리에서도 대화를 살리고 분위기를 가볍게 만들어.",moon:"감정이 머리로 먼저 가. 느끼기 전에 분석부터 하는 편이라, 스스로도 자기 감정을 헷갈려할 때가 있어. 같은 자리에 오래 머무는 걸 못 견뎌서, 변화와 새로운 자극이 있어야 마음이 살아나.",asc:"밝고 사교적인 인상이야. 말을 잘 걸고 분위기를 가볍게 만드는 재주가 있어서, 처음 보는 사람과도 금방 편해져. 표정이 살아있고 반응이 빨라서 함께 있으면 지루할 틈이 없어."},
  "게자리":{sun:"정이 많고 품이 넓은 별이야. 내 사람이라고 정한 사람은 끝까지 챙기고 지키는 따뜻함이 있어. 공감 능력이 깊어서 남의 아픔을 그냥 지나치질 못해.",moon:"감정의 깊이가 남달라. 공감 능력이 뛰어나서 가까운 사람의 기분을 그대로 흡수하고, 분위기만으로도 상대의 마음을 읽어.",asc:"부드럽고 다정한 인상이야. 처음엔 낯을 가리고 조심스러워 보여도, 한번 마음을 열면 따뜻하게 품어주는 사람이라는 게 느껴져. 상대를 편하게 배려하는 세심함이 자연스럽게 배어나와."},
  "사자자리":{sun:"타고난 주인공이야. 빛나는 자리가 어울리고, 사람을 끌어당기고 이끄는 카리스마가 있어. 당당하고 자존심이 강해서 위축되기보다 정면으로 부딪히는 걸 택해.",moon:"감정 표현이 화려하고 당당해. 사랑도 크게 주고 크게 받길 원하는 뜨거운 마음이야. 인정받고 주목받을 때 마음이 가장 충만해지고, 반대로 무시당하거나 존재감이 흐려질 때 깊이 위축돼.",asc:"화려하고 당당한 인상이야. 가만히 있어도 눈길이 가는 존재감을 뿜어내고, 자세나 표정에서 자신감이 자연스럽게 드러나."},
  "처녀자리":{sun:"섬세하고 완벽을 추구하는 별이야. 디테일을 놓치지 않고, 뭐든 제대로 해내려는 성실함이 몸에 배어 있어. 문제를 분석하고 정리하고 개선하는 능력이 탁월해서, 어디서든 없으면 안 되는 사람이 돼.",moon:"감정을 분석하고 정리하려 해. 느끼는 대로 두기보다 왜 이런 기분인지 따지는 편이라, 걱정이 많고 예민해. 그만큼 주변을 세심하게 챙기고 미리 대비하는 힘이 강해.",asc:"단정하고 깔끔한 인상이야. 빈틈없어 보이면서도 은근히 친근한 매력이 있어서 신뢰가 빨리 쌓여. 말과 행동에 군더더기가 없고, 상대를 세심하게 배려하는 게 자연스럽게 드러나."},
  "천칭자리":{sun:"균형과 조화의 별이야. 사람 사이를 매끄럽게 조율하고, 어느 한쪽으로 치우치지 않으려는 공정함이 있어. 미적 감각이 뛰어나서 아름다운 것, 세련된 것을 알아보고 만들어내는 재능이 있어.",moon:"관계 속에서 마음이 안정돼. 갈등을 싫어하고 평화를 지키려는 성향이 강해서, 부딪힐 상황을 미리 피하거나 맞춰주는 편이야. 혼자 있는 것보다 마음 맞는 사람과 함께일 때 편안해지는 구조야.",asc:"세련되고 우아한 인상이야. 부드러운 매너와 균형 잡힌 분위기로 상대를 편하게 만드는 재주가 있어. 표정이나 말투에 은은한 품위가 배어 있어서 첫인상에서 호감을 쉽게 얻어."},
  "전갈자리":{sun:"강렬하고 깊이 있는 별이야. 한번 빠지면 끝을 보는 몰입력과, 겉으론 차분해도 속엔 뜨거운 게 끓는 이중성이 있어. 통찰력이 날카로워서 표면 아래 숨은 진짜를 꿰뚫어 봐.",moon:"감정이 깊고 강렬해. 쉽게 드러내지 않지만 한번 마음을 주면 전부를 거는 사람이야. 신뢰가 감정의 핵심이라, 믿음이 쌓이면 끝까지 지키지만 신뢰가 무너지면 돌아서는 것도 확실해.",asc:"신비롭고 묘한 인상이야. 쉽게 속을 안 보여줘서 더 끌리는 타입이라, 첫인상부터 궁금증을 자아내. 눈빛에 힘이 있고, 말수가 적어도 존재감이 묵직해."},
  "사수자리":{sun:"자유와 모험의 별이야. 넓은 세상을 향한 갈망이 커서, 익숙한 자리에 머무는 걸 못 견뎌. 낙천적이고 솔직해서 마음에 담아두는 게 없고, 어디서든 긍정적인 기운을 퍼뜨려.",moon:"감정이 낙천적이고 시원시원해. 우울해도 금방 털고 일어나는 회복력이 있어서, 무거운 감정을 오래 붙들지 않아.",asc:"밝고 활기찬 인상이야. 스스럼없이 다가가는 친화력으로 어딜 가나 잘 어울리고, 함께 있으면 기분이 가벼워지는 사람이야. 솔직하고 유쾌한 말투가 벽을 금방 허물어."},
  "염소자리":{sun:"책임감과 인내의 별이야. 목표를 향해 묵묵히 오르는 등산가 기질이라, 느려도 결국 정상에 서는 사람이야. 현실적이고 계획적이어서, 헛된 꿈보다 실현 가능한 목표를 하나씩 이뤄가.",moon:"감정을 잘 드러내지 않고 안으로 삼켜. 진중하고 무게감 있어 보이지만, 속으로는 외로움과 부담을 많이 지고 사는 편이야.",asc:"진중하고 어른스러운 인상이야. 쉽게 흔들리지 않는 단단함이 신뢰를 주고, 나이보다 성숙해 보이는 무게감이 있어. 말과 행동이 신중해서 함부로 대하기 어려운 분위기를 자연스럽게 풍겨."},
  "물병자리":{sun:"독창적이고 자유로운 별이야. 남들과 다른 시선으로 세상을 보고, 틀에 갇히는 걸 거부하는 개성이 뚜렷해. 관습에 얽매이지 않고 왜 꼭 그래야 하냐고 묻는 혁신가 기질이 있어.",moon:"감정을 객관적으로 봐. 한 발 떨어져 관찰하는 편이라 차가워 보이기도 하지만, 실은 감정에 휩쓸리지 않으려는 자기 방어야.",asc:"독특하고 개성 있는 인상이야. 어딘가 남다른 분위기로 사람들의 호기심을 끌고, 흔한 틀에 안 갇히는 자유로움이 매력이야. 편견 없이 사람을 대해서 누구와도 스스럼없이 어울려."},
  "물고기자리":{sun:"감수성과 상상력의 별이야. 공감 능력이 깊고 예술적 기질이 강해서, 남이 못 느끼는 결까지 섬세하게 잡아내. 경계가 흐릿해서 타인의 감정에 쉽게 스며들고, 그만큼 따뜻하게 품어주는 힘이 있어.",moon:"감정이 바다처럼 깊고 넓어. 타인의 아픔을 내 것처럼 느끼는 공감력이 강해서, 주변 분위기를 그대로 흡수해버려. 꿈과 예술, 음악과 물처럼 부드러운 것 속에서 마음이 치유되는 구조야.",asc:"부드럽고 몽환적인 인상이야. 어딘가 신비롭고 포근한 분위기로 사람을 끌어당기고, 함께 있으면 마음이 편안해지는 사람이야."}
};
// 데칸(Decan): 별자리를 3등분, 각 데칸은 같은 원소의 다른 별자리 영향을 받음 (전통 점성술 표준 방식)
const ELEMENT_CYCLE = {
  불: ["양자리", "사자자리", "사수자리"],
  흙: ["황소자리", "처녀자리", "염소자리"],
  바람: ["쌍둥이자리", "천칭자리", "물병자리"],
...
const SIGN_ELEMENT = { 양자리: "불", 사자자리: "불", 사수자리: "불", 황소자리: "흙", 처녀자리: "흙", 염소자리: "흙", 쌍둥이자리: "바람", 천칭자리: "바람", 물병자리: "바람", 게자리: "물", 전갈자리: "물", 물고기자리: "물" }
const DECAN_RANGES = {
  양자리: [[3, 21], [3, 31], [4, 10]], 황소자리: [[4, 20], [4, 30], [5, 11]], 쌍둥이자리: [[5, 21], [6, 1], [6, 11]],
  게자리: [[6, 21], [7, 2], [7, 12]], 사자자리: [[7, 23], [8, 2], [8, 13]], 처녀자리: [[8, 23], [9, 2], [9, 12]],
  천칭자리: [[9, 23], [10, 3], [10, 13]], 전갈자리: [[10, 23], [11, 2], [11, 12]], 사수자리: [[11, 22], [12, 2], [12, 12]],
  염소자리: [[12, 22], [1, 1], [1, 10]], 물병자리: [[1, 20], [1, 30], [2, 9]], 물고기자리: [[2, 19], [3, 1], [3, 11]],
}
function calcDecan(sign, month, day) {
  const ranges = DECAN_RANGES[sign]
  if (!ranges) return { num: 1, influenceSign: sign }
  const md = month * 100 + day
  // 염소자리처럼 해를 넘는 별자리 보정 (12월 시작 ~ 1월 끝)
  const norm = (m, d) => (sign === "염소자리" && m <= 1) ? (m + 12) * 100 + d : m * 100 + d
  const nmd = norm(month, day)
  const bounds = ranges.map(([m, d]) => norm(m, d))
  let num = 3
  if (nmd < bounds[1]) num = 1
  else if (nmd < bounds[2]) num = 2
  const cycle = ELEMENT_CYCLE[SIGN_ELEMENT[sign]]
  const idx = cycle.indexOf(sign)
  const influenceSign = num === 1 ? sign : cycle[(idx + num - 1) % 3]
  return { num, influenceSign }
}
// 문페이즈(달의 위상): 삭望 주기 기준 8단계 판정
function calcMoonPhase(year, month, day) {
  const jdn = (y, m, d) => { const a = Math.floor((14 - m) / 12); const yy = y + 4800 - a; const mm = m + 12 * a - 3
    return d + Math.floor((153 * mm + 2) / 5) + 365 * yy + Math.floor(yy / 4) - Math.floor(yy / 100) + Math.floor(yy / 400) - 32045 }
  const synodic = 29.530588861
  const refJD = 2451550.1 // 2000-01-06 18:14 UTC 신월 기준점
  const days = jdn(year, month, day) - refJD
  let phase = (days % synodic) / synodic
  if (phase < 0) phase += 1
  const names = ["신월", "초승달", "상현달", "상현망", "보름달", "하현망", "하현달", "그믐달"]
...
function buildAstro(year, month, day, hour, minute, noTime){
  ...
  const decan = calcDecan(sun, month, day);
  const moonPhase = calcMoonPhase(year, month, day);
  const retrograde = {
    수성: isPlanetRetrograde("수성", year, month, day),
    금성: isPlanetRetrograde("금성", year, month, day),
    화성: isPlanetRetrograde("화성", year, month, day),
  };
  return { sun, moon, asc,
    sunDesc:ZODIAC_DESC[sun]?.sun||"", moonDesc:ZODIAC_DESC[moon]?.moon||"",
    ascDesc:asc?(ZODIAC_DESC[asc]?.asc||""):"",
    decan, moonPhase, retrograde };
}

// ━━ 행성 역행 판정 (JPL 저정밀 케플러 궤도요소 기반, 표 없이 임의 날짜 계산 가능) ━━
// 출처: JPL Keplerian Elements for Approximate Positions of the Major Planets (유효기간 1800~2050년)
const PLANET_ELEMENTS = {
  수성: { a: [0.38709927, 0.00000037], e: [0.20563593, 0.00001906], I: [7.00497902, -0.00594749], L: [252.25032350, 149472.67411175], peri: [77.45779628, 0.16047689], node: [48.33076593, -0.12534081] },
  금성: { a: [0.72333566, 0.00000390], e: [0.00677672, -0.00004107], I: [3.39467605, -0.00078890], L: [181.97909950, 58517.81538729], peri: [131.60246718, 0.00268329], node: [76.67984255, -0.27769418] },
  화성: { a: [1.52371034, 0.00001847], e: [0.09339410, 0.00007882], I: [1.84969142, -0.00813131], L: [-4.55343205, 19140.30268499], peri: [-23.94362959, 0.44441088], node: [49.55953891, -0.29257343] },
  지구: { a: [1.00000261, 0.00000562], e: [0.01671123, -0.00004392], I: [-0.00001531, -0.01294668], L: [100.46457166, 35999.37244981], peri: [102.93768193, 0.32327364], node: [0.0, 0.0] },
}
function _toJDN(y, m, d) {
  // 그레고리력 → 율리우스적일수 (정오 기준, 오차 무시 가능한 수준)
  const a = Math.floor((14 - m) / 12), yy = y + 4800 - a, mm = m + 12 * a - 3
  return d + Math.floor((153 * mm + 2) / 5) + 365 * yy + Math.floor(yy / 4) - Math.floor(yy / 100) + Math.floor(yy / 400) - 32045
}
function _deg2rad(d) { return (d % 360) * Math.PI / 180 }
function _heliocentricEcliptic(elName, T) {
  const el = PLANET_ELEMENTS[elName]
  ...
  let M = ((L - peri) % 360 + 540) % 360 - 180 // -180~180
  const eStar = e * 180 / Math.PI
  let E = M + eStar * Math.sin(_deg2rad(M))
  for (let i = 0; i < 6; i++) {
    const dM = M - (E - eStar * Math.sin(_deg2rad(E)))
    const dE = dM / (1 - e * Math.cos(_deg2rad(E)))
    E += dE
  }
  const xp = a * (Math.cos(_deg2rad(E)) - e)
  const yp = a * Math.sqrt(1 - e * e) * Math.sin(_deg2rad(E))
  const cosNode = Math.cos(_deg2rad(node)), sinNode = Math.sin(_deg2rad(node))
  const cosPN = Math.cos(_deg2rad(peri - node)), sinPN = Math.sin(_deg2rad(peri - node))
  const cosI = Math.cos(_deg2rad(I)), sinI = Math.sin(_deg2rad(I))
  const x = (cosNode * cosPN - sinNode * sinPN * cosI) * xp + (-cosNode * sinPN - sinNode * cosPN * cosI) * yp
  const y = (sinNode * cosPN + cosNode * sinPN * cosI) * xp + (-sinNode * sinPN + cosNode * cosPN * cosI) * yp
  return { x, y }
}
function _geoLongitude(planetName, jd) {
  const T = (jd - 2451545.0) / 36525
  const p = _heliocentricEcliptic(planetName, T)
  const earth = _heliocentricEcliptic("지구", T)
  const gx = p.x - earth.x, gy = p.y - earth.y
  return Math.atan2(gy, gx) * 180 / Math.PI
}
// 특정 날짜(연,월,일)에 해당 행성이 역행 중인지 판정 — 하루 전후 겉보기 경도 변화로 판단
function isPlanetRetrograde(planetName, year, month, day) {
  if (!PLANET_ELEMENTS[planetName]) return false
  const jd = _toJDN(year, month, day)
  const lam0 = _geoLongitude(planetName, jd - 1)
  const lam1 = _geoLongitude(planetName, jd + 1)
  let diff = lam1 - lam0
...
function buildSajuData(input){
  ...
  const LP_DESC2={
    1:"가진 도구로 무언가를 실제로 만들어내는 게 이번 생의 경로야. 아이디어를 머릿속에만 두지 않고 행동으로 옮길 때 인생이 풀려. 스스로 시작하고 이끄는 자리에 설 때 존재감이 가장 커지는 구조야. 남이 만든 판에 들어가기보다, 자기 판을 여는 쪽이 이 생명숫자의 정답이야.",
    2:"보이지 않는 흐름을 먼저 읽어내는 게 이번 생의 경로야. 확신이 서기 전에도 직관이 먼저 답을 알려주는 타입이라, 그 감각을 믿고 따라가는 게 맞아. 조용히 관찰하고 때를 기다리는 인내심이 결국 큰 그림을 완성해. 서두르지 말고 흐름이 무르익을 때까지 기다리는 게 이 생명숫자의 힘이야.",
    3:"품고 있는 걸 밖으로 꺼내 표현하는 게 이번 생의 경로야. 만들고 낳고 키우는 창조적인 에너지가 삶 전반에 흘러. 사람들 앞에서 표현할수록, 나눠줄수록 오히려 채워지는 구조야. 안에만 담아두면 답답해지니 계속 밖으로 꺼내는 연습이 필요해.",
    4:"차곡차곡 쌓아 단단한 걸 세우는 게 이번 생의 경로야. 화려한 한 방보다 꾸준한 축적이 이 생명숫자의 무기야. 체계와 원칙을 세워두면 그 안에서 가장 큰 힘을 발휘해. 조급하게 결과를 재촉하기보다, 기초부터 다지는 방식이 결국 가장 빠른 길이야.",
    5:"경험을 통해 배우고 넓혀가는 게 이번 생의 경로야. 틀에 갇히기보다 다양한 걸 겪어보며 자신만의 답을 찾아가는 타입이야. 가르치고 나누는 자리에서도 빛을 발해. 한 곳에 너무 오래 머물면 정체되니, 계속 새로운 걸 받아들이는 유연함이 필요해.",
    6:"관계 속에서 선택하고 책임지는 게 이번 생의 경로야. 사랑과 조화를 만들어내는 능력이 타고났고, 중요한 갈림길마다 마음이 향하는 방향이 답인 경우가 많아. 혼자보다 함께일 때 에너지가 커지는 구조야. 다만 남을 위한 선택과 나를 위한 선택 사이 균형을 잃지 않는 게 관건이야.",
    7:"본질을 파고들어 답을 찾아가는 게 이번 생의 경로야. 방향이 여러 갈래로 흩어져도 결국 하나의 목표를 향해 밀고 나가는 힘이 있어. 깊이 파는 만큼 남들이 못 보는 걸 보게 돼. 속도를 늦추더라도 방향을 잃지 않는 게 이 생명숫자의 승부처야.",
    8:"현실에서 구체적인 성취를 만들어내는 게 이번 생의 경로야. 막연한 이상보다 손에 잡히는 결과를 밀어붙이는 추진력이 강해. 어려운 상황일수록 오히려 저력을 발휘하는 타입이야. 힘으로만 누르기보다 부드럽게 다루는 법을 익히면 훨씬 크게 성취해.",
    9:"경험한 걸 정리하고 세상에 나눠주는 게 이번 생의 경로야. 개인의 성취를 넘어 더 큰 가치에 기여할 때 삶이 완성되는 구조야. 놓아주고 마무리 짓는 힘이 남달라. 붙잡고 있던 걸 내려놓는 순간, 다음 챕터가 열려.",
    11:"영감을 현실로 연결하는 게 이번 생의 사명이야. 마스터 넘버라 남들보다 예민한 촉과 더 큰 책임감을 함께 타고났어. 이상과 현실 사이에서 자주 흔들리지만, 그 긴장 자체가 성장의 재료야. 감각을 믿고 한 걸음씩 현실에 내려놓는 연습이 이 생명숫자를 완성해.",
    22:"거대한 비전을 실제 구조로 세우는 게 이번 생의 사명이야. 마스터 넘버 22로서, 꿈꾸는 크기와 실현하는 능력을 동시에 갖췄어. 많은 사람에게 영향을 미치는 일에 자연스럽게 이끌려. 책임의 무게에 짓눌리지 않으려면, 작은 성취부터 차곡차곡 증명해가는 게 중요해.",
    33:"조건 없이 품고 헌신하는 게 이번 생의 사명이야. 마스터 넘버 33으로, 개인을 넘어선 더 큰 사랑과 책임을 타고났어. 주변 사람들에게 미치는 영향력이 크고 깊어. 자신을 다 소진하지 않도록, 주는 만큼 채우는 균형이 필요해.",
  };
  const lifePathCard=LP_CARDS[lp]||`${lp}번 카드`;
  const lifePathDesc=LP_DESC2[lp]||`생명경로수 ${lp}번의 에너지야.`;
  // 영혼 카드 긴 설명 (성취 카드와 유사한 분량)
  const SOUL_DESC={
    1:"내면 깊은 곳에 '내 힘으로 무언가를 시작하고 싶다'는 강한 의지가 자리해. 누군가 정해준 길을 따라가기보다, 스스로 첫 발자국을 찍을 때 비로소 살아있음을 느끼는 영혼이야.",
    2:"겉으로 드러내기보다 조용히 느끼고 헤아리는 데서 안정을 얻는 영혼이야. 말로 다 표현되지 않는 미묘한 감정과 분위기를 예민하게 감지하고, 사람과 사람 사이를 부드럽게 잇는 역할에서 깊은 보람을 느껴.",
    3:"무언가를 만들어내고 표현할 때 영혼이 가장 환하게 빛나. 감정과 생각을 안에만 담아두면 답답해지고, 그것을 말·글·작품, 관계로 풀어낼 때 비로소 자유로워져. 사람들을 즐겁게 하고 분위기를 살리는 타고난 감각이 있어.",
    4:"질서와 안정 속에서 마음이 편안해지는 영혼이야. 단단한 기초를 다지고 하나하나 쌓아 올릴 때 깊은 만족을 느끼고, 약속과 책임을 지키는 것에서 자기 가치를 확인해. 화려함보다 꾸준함, 즉흥보다 계획을 신뢰하는 성실한 본성이 있어.",
    5:"자유롭게 움직이고 새로운 것을 경험할 때 영혼이 숨을 쉬어. 한 자리에 오래 묶여 있으면 답답함을 느끼고, 변화와 모험 속에서 자신을 발견하는 타입이야. 호기심이 넘쳐 다양한 세계를 탐험하며 끊임없이 성장해.",
    6:"사랑하고 보살피는 관계 속에서 영혼이 완성되는 타입이야. 가까운 사람을 챙기고 책임지는 데서 깊은 의미를 찾고, 따뜻함과 조화를 만들어내는 능력이 탁월해. 누군가에게 기댈 곳이 되어줄 때 가장 자기다움을 느껴.",
    7:"홀로 깊이 사유하고 본질을 파고들 때 영혼이 충만해지는 타입이야. 표면적인 답에 만족하지 못하고, 보이지 않는 원리와 진실을 탐구하는 데서 기쁨을 느껴. 혼자만의 고요한 시간이 곧 에너지의 원천이야.",
    8:"현실에서 구체적인 성취를 이뤄낼 때 영혼이 살아나는 타입이야. 막연한 이상보다 손에 잡히는 결과를 만들고, 자신의 힘으로 영향력과 풍요를 일궈낼 때 깊은 만족을 느껴. 강한 추진력과 현실 감각이 타고난 무기야.",
    9:"세상에 베풀고 더 큰 가치에 기여할 때 영혼이 빛나는 타입이야. 개인의 이익을 넘어 모두를 위한 무언가를 할 때 깊은 의미를 느끼고, 따뜻한 이해심과 넓은 시야를 가졌어. 많은 것을 품고 놓아줄 줄 아는 성숙함이 본성이야.",
    11:"영감과 이상을 좇으며 사람들에게 빛을 비추는 영혼이야. 마스터 넘버 11로서, 직관이 남달리 예민하고 보이지 않는 가능성을 먼저 감지해. 자신보다 큰 무언가와 연결되어 있다는 감각이 늘 마음 깊은 곳에 있어.",
    22:"꿈을 현실의 구조물로 빚어내는 위대한 건축가의 영혼이야. 마스터 넘버 22로서, 거대한 비전을 품으면서도 그것을 실제로 세워낼 수 있는 드문 힘을 가졌어. 많은 사람에게 영향을 미치는 일에서 깊은 사명감을 느껴.",
  };
  ...
  const yearForecast=[CY,CY+1,CY+2,CY+3,CY+4].map(yr=>{
    ...
    return{year:yr,score:sc,summary:bandSummary(sc),areas:calcSeunAreas(yr,0,scoreMeta,ilgan)};
  });
  const monthForecast=Array.from({length:12},(_,i)=>{
    ...
    return{year:yr,month:mo,label:`${yr}.${mo}`,ganji:gj.ko,score:sc,summary:bandSummary(sc),areas:calcSeunAreas(yr,mo,scoreMeta,ilgan),isThis:i===0};
  });
  ...
  const tojungYearFlow=yrs5.map(yr=>{
    ...
    return{year:yr,score:sc,month:sc>=82?"대길":sc>=66?"평운":"주의",desc:bandSummary(sc),areas:calcSeunAreas(yr,0,scoreMetaSaju,ilgan)};
  });
