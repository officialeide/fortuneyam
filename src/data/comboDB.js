...
const COMBO_DESC={
  ...
  "화개성_관대(冠帶)":"화개성의 예술·신비 기운이 관대(冠帶)의 자기 표출 에너지와 만나요. 사회에 나서는 시기에 독창적인 감성과 개성이 자연스럽게 드러나는 구조예요. 재능을 세상에 알리기 좋은 조합이에요.",
  ...
  "화개성_병(病)":"화개성과 병(病)이 만나 예술·영적 에너지가 내면으로 깊이 침잠하는 구조예요. 외부 활동보다 혼자만의 창작과 사색에서 진짜 힘이 나오는 시기예요. 무리하지 않고 흐름을 따르는 것이 좋아요.",
  "화개성_사(死)":"화개성과 사(死)가 만나 외부보다 내면 탐구와 예술적 사색이 깊어지는 구조예요. 은둔 속에서 가장 깊은 창작물이 탄생하는 패턴이에요.",
  "화개성_묘(墓)":"화개성의 예술·신비 에너지가 묘(墓) 안에 차곡차곡 쌓이는 구조예요. 겉으로는 조용해 보여도 내면에 독창적인 세계가 깊이 축적되고 있어요. 때가 되면 한꺼번에 터져나오는 패턴이에요.",
