...
const S={
  ...
  tab:{flex:"0 0 auto",padding:"11px 6px 8.5px",fontSize:10,fontWeight:600,background:"none",border:"none",color:"#bbb",cursor:"pointer",transition:"color .2s",textAlign:"center",letterSpacing:"-0.2px",outline:"none",WebkitTapHighlightColor:"transparent"},
  tabA:{color:"#e65100",borderBottom:"2.5px solid #e65100"},
