...
const S={
  ...
  tab:{flex:"0 0 auto",padding:"11px 6px",fontSize:10,fontWeight:600,background:"none",border:"none",color:"#bbb",cursor:"pointer",borderBottom:"2.5px solid transparent",transition:"color .2s,border-color .2s",textAlign:"center",letterSpacing:"-0.2px",outline:"none"},
